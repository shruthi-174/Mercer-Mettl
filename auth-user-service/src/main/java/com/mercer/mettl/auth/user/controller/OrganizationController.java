package com.mercer.mettl.auth.user.controller;
...
import com.mercer.mettl.auth.user.service.OrganizationService;
...
public class OrganizationController {
    ...
    @PostMapping("/create")
    public ResponseEntity<MessageOutDto> createOrganization(final @RequestBody OrganizationInDto organizationDto) {
