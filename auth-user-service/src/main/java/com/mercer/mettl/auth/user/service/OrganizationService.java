package com.mercer.mettl.auth.user.service;

import com.mercer.mettl.auth.user.constants.Constants;
import com.mercer.mettl.auth.user.constants.ErrorMessage;
import com.mercer.mettl.auth.user.dto.MessageOutDto;
import com.mercer.mettl.auth.user.dto.OrganizationInDto;
import com.mercer.mettl.auth.user.dto.OrganizationOutDto;
import com.mercer.mettl.auth.user.dto.OrganizationUpdateDto;
import com.mercer.mettl.auth.user.entity.Organization;
import com.mercer.mettl.auth.user.exception.ResourceConflictException;
import com.mercer.mettl.auth.user.exception.ResourceNotFoundException;
import com.mercer.mettl.auth.user.repository.OrganizationRepository;
