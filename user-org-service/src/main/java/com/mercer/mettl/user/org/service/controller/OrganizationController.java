...
public class OrganizationController {
    ...
    public ResponseEntity<MessageOutDto> createOrganization(final @RequestHeader("X-ROLE") String role,
        ...
        if (!(Constants.ADMIN).equals(role)) {
            log.error("Unauthorized access attempt to create organization by role: {}", role);
